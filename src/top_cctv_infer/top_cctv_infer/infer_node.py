...
class TopCctvInfer(Node):
    def __init__(self):
        ...
        self.declare_parameter("ref_mode", "center")
        ...
        self.sub = self.create_subscription(
            Image, image_topic, self.on_image, qos_img
        )

        # self.sub = self.create_subscription(
        #     Image, image_topic, self.on_image, qos_profile_sensor_data
        # )
        #self.pub_annot = self.create_publisher(Image, self.annot_topic, qos_profile_sensor_data)
